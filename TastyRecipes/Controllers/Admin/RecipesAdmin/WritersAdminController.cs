...
{
    public class WritersAdminController : Controller
    {
        private readonly ApplicationDbContext _context;

        public WritersAdminController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        // GET: WritersAdmin/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: WritersAdmin/Create
